...
DEFINE VARIABLE StartForm AS Playground.MemoryLeak.Telerik.StartWindowManagerClientForm.


ASSIGN StartForm = NEW Playground.MemoryLeak.Telerik.StartWindowManagerClientForm().
